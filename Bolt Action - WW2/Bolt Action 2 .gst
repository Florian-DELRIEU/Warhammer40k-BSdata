...
<gameSystem id="d373-d979-116c-5487" name="Bolt Action 2.0" revision="2" battleScribeVersion="2.03" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <publications>
    ...
    <publication id="acdd-6d49-99f4-7e88" name="Bolt Action Rulebook" shortName="BA - Rules" publisherUrl="https://fr.scribd.com/read/322820449/Bolt-Action-World-War-II-Wargames-Rules-Second-Edition#"/>
    <publication id="7035-d623-c8bd-4456" name="Personnals rules" shortName="PERSO" publisherUrl="https://github.com/Florian-DELRIEU/Warhammer40k-BSdata/wiki/Bolt-Action-Rules-summary"/>
  </publications>
  <costTypes>
  ...
  <sharedRules>
    ...
    <rule id="8a7d-230c-d090-127b" name="Bicycles" publicationId="acdd-6d49-99f4-7e88" page="195" hidden="false">
      <description>- Double la distance de _run_ sur route (24&quot; comme véhicule)
- Si reçoit un _pin markers_, descend du vélo pour le reste de la partie</description>
    </rule>
    <rule id="525c-47c4-f59c-5c9a" name="Cavalry" publicationId="acdd-6d49-99f4-7e88" page="196" hidden="false">
      <description>- move = 9&quot;  / run = 18&quot;
- peut demonter mais pas remonter a cheval
- Peut pas down mais peut faire un mouvement d&apos;escape (comme reco)
- Ne peut utiliser que les pistolet sur cheval
- regle speciale : tough fighter</description>
    </rule>
...
The crew can fire the LMG or the main gun, but not both at the same time</description>
    ...
    <rule id="210a-fd8c-dd39-5e36" name="Fanatics" publicationId="7035-d623-c8bd-4456" page="198" hidden="false">
      <description>- Test de moral uniquement si 1 seul survivant dans l&apos;escouade
- Ne fuient pas quand ils ont trop de _pin marlers_ mais peuvent rien faire
- Se battent jusqu&apos;au dérnier au CAC (pas de fuite si ils perdent un round)</description>
    </rule>
...
Infantry takes D3+1 pin markers for being hit by a flamethrower</description>
    ...
    <rule id="c21d-d23f-d16a-bf33" name="Green" publicationId="acdd-6d49-99f4-7e88" page="199" hidden="false">
      <description>When the unit suffers its first casualty roll a die: 
- on a roll of 1 the unit suffers an additional D6 Pin Markers and goes Down;
- on a roll of 2,3 or 4 nothing happens;
- on a roll of 5 or 6 the unit is immediately uprated to Regular (morale to 9) for the rest of the battle.</description>
    </rule>
    <rule id="95d0-d47a-8684-c817" name="Gun Shield" publicationId="acdd-6d49-99f4-7e88" page="215" hidden="false">
      <description>- add +1 bonus for damage crew (HE et Flame pas affectés)</description>
    </rule>
...
Can fire Smoke Screens</description>
    ...
    <rule id="a9e6-1bf4-b097-df12" name="Motorbikes" publicationId="acdd-6d49-99f4-7e88" page="200" hidden="false">
      <description>- advance to 12&quot; / run to 24&quot;
- peut down ou faire un escape (recce)
- peut demonter
- se bat comme infantery au CAC, peut regrouper de 2D6&quot; </description>
    </rule>
...
Never suffer -1 penalty at penetration for firing at long range</description>
    ...
    <rule id="df62-2282-8e14-569c" name="Shirkers" publicationId="acdd-6d49-99f4-7e88" page="201" hidden="false">
      <description>- Doit toujours faire un test de moral
- les _pin markers_ compte double </description>
    </rule>
    ...
    <rule id="6bcb-f463-20a7-0b4a" name="Sniper" publicationId="acdd-6d49-99f4-7e88" page="203" hidden="false">
      <description>When firing under Fire or Ambush orders only:
- Range is 36&quot; and hits at +1
- Compte comme execptionnel damage
...
- Ignores the Gun Shield rule</description>
    ...
    <rule id="4347-c6e1-c5ab-9232" name="Stubborn" publicationId="acdd-6d49-99f4-7e88" page="204" hidden="false">
      <description>- Ignore les modificateur de moral pour les test de moral</description>
    </rule>
    <rule id="123f-ba11-633a-56ff" name="Tough Fighters" publicationId="acdd-6d49-99f4-7e88" page="206" hidden="false">
      <description>- peut faire un 2nd dommage au CAC quand ils en réussissent un (non cumulable)
- regroupement de 2D6&quot; après un CAC
</description>
    </rule>
